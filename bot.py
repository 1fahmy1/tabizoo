...
class TabiZoo:
    def __init__(self):
        ...
        # Initialize banner with your custom message
        self.banner = base.create_banner(game_name="Trick Alert 🔥 Auto Claimer")
    ...
    def print_custom_banner(self):
        print(base.yellow + "===================================" + base.reset)
        print(base.yellow + "  Trick Alert 🔥  Auto Claimer" + base.reset)
        print(base.yellow + "  Join our Telegram Channel: " + base.reset + base.green + "https://t.me/Trickalert" + base.reset)
        print(base.yellow + "===================================" + base.reset)
    ...
    def main(self):
        # عرض الرسالة الترحيبية لمرة واحدة
        self.print_custom_banner()

        while True:
            # قم بإزالة أو تعليق هذا السطر
            # print(self.banner)
